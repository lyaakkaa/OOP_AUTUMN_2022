...
public class Mark implements Serializable{
	...
	public String totalMark() {
		...
		if (this.getTotal() >= 95 && this.getTotal() <= 100) 
            ...
            if (this.getTotal() >= 90)
            	letter = "A-"; 
            else if (this.getTotal() >= 85) 
            	letter = "B+"; 
            else if (this.getTotal() >= 80) 
            	letter = "B"; 
            else if (this.getTotal() >= 75) 
            	letter = "B-"; 
            else if (this.getTotal() >= 70) 
            	letter = "C+"; 
            else if (this.getTotal() >= 65) 
            	letter = "C"; 
            else if (this.getTotal() >= 60) 
            	letter = "C-"; 
            else if (this.getTotal() >= 55) 
            	letter = "D+"; 
            else if (this.getTotal() >= 50) 
            	letter = "D"; 
            else letter = "F";
