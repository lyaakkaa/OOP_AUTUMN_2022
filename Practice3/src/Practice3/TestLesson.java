...
public class TestLesson {
	...
	public static void main(String[] args) {
		...
		Lesson oop = new Lesson("OOP", Days.TUE, new Time(14,30), Format.OFFLINE, new Time(2), Type.lection, new Room(4, 50, 461));
		Lesson algo = new Lesson("ADS", Days.WED, new Time(13,30), Format.ONLINE, new Time(1, 30), Type.lab, new Room(3, 50, 375));
		Lesson db = new Lesson("DB", Days.TUE, new Time(15,30), Format.OFFLINE, new Time(2), Type.lection, new Room(2, 100, 243));
		Lesson math = new Lesson("MATH", Days.TUE, new Time(19,30)); //Format will be null
		math.format = Format.ONLINE;
		
		System.out.println(oop.getEndTime());
